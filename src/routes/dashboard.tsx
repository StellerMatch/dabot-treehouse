  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt="Clarity"
        aria-hidden
        className="pointer-events-none fixed z-10 select-none right-[-60px] bottom-[40px] h-[260px] sm:right-2 sm:bottom-[220px] sm:h-[320px] lg:right-8 lg:bottom-32 lg:h-[640px]"
        style={{
          width: "auto",
