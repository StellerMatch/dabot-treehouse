...
function SelectedIdeaSoilBackground() {
  return (
    <div
      aria-hidden
      className="pointer-events-none fixed inset-0 -z-30 overflow-hidden bg-[#241006]"
    >
      <div
        className="absolute inset-0"
        style={{
          background:
            "radial-gradient(circle at 18% 22%, rgba(112,68,31,0.52) 0 2px, transparent 3px), radial-gradient(circle at 72% 18%, rgba(72,39,17,0.7) 0 1.5px, transparent 3px), radial-gradient(circle at 34% 76%, rgba(151,95,45,0.36) 0 1px, transparent 2px), radial-gradient(circle at 83% 66%, rgba(54,29,13,0.75) 0 2px, transparent 4px), repeating-linear-gradient(8deg, rgba(85,47,19,0.24) 0 2px, transparent 2px 8px), linear-gradient(180deg, #4a2811 0%, #321707 52%, #1b0903 100%)",
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 50% 18%, rgba(245,188,105,0.28), transparent 45%), radial-gradient(ellipse at 50% 84%, rgba(222,149,72,0.30), transparent 48%), linear-gradient(180deg, rgba(18,8,3,0.18), rgba(18,8,3,0.2) 42%, rgba(10,4,1,0.72))",
        }}
      />
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, transparent 0%, rgba(91,51,20,0.30) 35%, rgba(20,9,3,0.82) 100%)",
        }}
      />
    </div>
  );
...
function Dashboard() {
  ...
  return (
    ...
    >
      {/* Library view keeps the tree room; opened ideas move down into the soil. */}
      {selected ? (
        <SelectedIdeaSoilBackground />
      ) : (
        <div
          aria-hidden
...
function DraggableOwl({ src }: { src: string }) {
  ...
  return (
    <img
      ...
      src={src}
      alt=""
      className="fixed select-none object-contain cursor-move left-[-10vw] bottom-[88px] top-auto h-[37vh] z-[15] md:left-[3.6vw] md:top-[42vh] md:bottom-auto md:h-[32vh] md:z-[5] lg:left-[23vw] lg:top-[28vh]"
      style={{
        width: "auto",
